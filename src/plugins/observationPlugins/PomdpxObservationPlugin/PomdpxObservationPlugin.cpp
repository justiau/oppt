...
namespace oppt
{
class PomdpxObservationPlugin: public ObservationPlugin
{
public :
    PomdpxObservationPlugin():
        ObservationPlugin() {
    }

    virtual ~PomdpxObservationPlugin() = default;
...
OPPT_REGISTER_OBSERVATION_PLUGIN(PomdpxObservationPlugin)
